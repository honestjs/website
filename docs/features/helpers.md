...
import {
  ...
  JwtPayload,
  UploadedFile,
} from "./decorators/parameter.decorators";
...
export class UsersController {
  @Get()
  async findAll(
    @Pagination({ sortBy: "name", sortOrder: "asc" }) pagination: any,
  ) {
