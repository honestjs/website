...
export default defineConfig({
  ...
  title: "HonestJS",
  description:
    "Fast, minimal, and structured. Hono performance meets Nest architecture for scalable apps.",
  lastUpdated: true,
  cleanUrls: true,
  ...
  themeConfig: {
        ...
        items: [
          {
            ...
            link: "/docs/concepts/project-organization",
          },
          {
            text: "Dependency Injection",
            link: "/docs/concepts/dependency-injection",
          },
    ...
    footer: {
      ...
      copyright:
        "Copyright © 2025-present Orkhan Karimov & HonestJS contributors.",
    },
